...
-a) Делаете дамп вашей схемы данных (для командной строки пример - 'pg_dump -n eugeneai –insert study') в клиенте
  
- b) Отдаете в ваш чат Deepseek с запросом на проверку
  
- c) Добавляете результат в отчет
